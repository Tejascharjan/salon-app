...
export const GET_CATEGORY_BY_SALON_REQUEST = "GET_CATEGORY_BY_SALON_REQUEST";
export const GET_CATEGORY_BY_SALON_SUCCESS = "GET_CATEGORY_BY_SALON_SUCCESS";
export const GET_CATEGORY_BY_SALON_FAILURE = "GET_CATEGORY_BY_SALON_FAILURE";
