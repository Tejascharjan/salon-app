...
export const chartReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case FETCH_EARNINGS_FAILURE:
            return { ...state, earnings: { loading: false, data: null, error: action.payload } };
        case FETCH_BOOKINGS_REQUEST:
            return { ...state, bookings: { loading: true, data: null, error: null } };
        case FETCH_BOOKINGS_SUCCESS:
            return { ...state, bookings: { loading: false, data: action.payload, error: null } };
        case FETCH_BOOKINGS_FAILURE:
            return { ...state, bookings: { loading: false, data: null, error: action.payload } };
        default:
            return state;
    }
}